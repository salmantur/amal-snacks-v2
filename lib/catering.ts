...
export const CATERING_TIERS: CateringTier[] = [
  ...
  },
  {
    ...
    mainDishPool: CATERING_MAIN_DISHES,
    sideRule: { pool: CATERING_SIDES_POOL, min: 2, max: 2 },
    features: ["4 سخانات تختارها", "2 مقبلات او سلطات", "توصيل مجاني", "تكفي 20–30 ضيف"],
    highlighted: false,
  },
  {
    id: "tier2",
    ...
    features: ["5 سخانات تختارها", "2–3 مقبلات وسلطات حسب اختيارك", "توصيل مجاني", "تكفي 30–40 ضيف"],
    highlighted: true,
  },
]

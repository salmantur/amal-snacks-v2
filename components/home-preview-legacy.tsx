...
import { Heart, Home, Menu, Plus, Search, ShoppingBag, SlidersHorizontal, Sparkles, User } from "lucide-react"
...
/**
 * Superseded by EditorialPreview (the live default). Kept only as opt-in
 * design previews via ?homeui=studio|soft|market, so this lives in its own
 * lazily-loaded chunk instead of shipping to every real visitor.
 */

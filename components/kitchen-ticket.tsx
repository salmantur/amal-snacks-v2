...
import { Clock, Phone, MapPin, ChefHat, CheckCircle, Truck, Printer, Store } from "lucide-react"
  ...
  return (
    <div
      className={cn(
        ...
        order.status === "delivered" && "border-border opacity-70"
      )}
      dir="rtl"
    >
      ...
      <div className="p-4 space-y-4">
        ...
        <button
          ...
          className={cn(
            ...
            printSuccess ? "border-green-500 bg-green-50 text-green-700" : "border-border hover:bg-amal-grey"
          )}
        >
        ...
        {showIpEdit ? (
          <div className="flex gap-2">
            <input
              ...
              id={`printer-ip-${order.id}`}
            />
            <button
              onClick={() => {
                const input = document.getElementById(`printer-ip-${order.id}`) as HTMLInputElement | null
